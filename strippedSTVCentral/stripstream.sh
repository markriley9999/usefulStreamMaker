...
if [ "$1" == "--fixav" ]; then
    ...
    tsmask tmp/spts-stv.ts -0 -16 -17 > tmp/spts-stv-nosi.ts
    tsmask tmp/spts-stvplus1.ts -0 -16 -17 > tmp/spts-stvplus1-nosi.ts
    ...
    tscbrmuxer c:1200000 tmp/spts-stv-nosi.ts b:1200000 tmp/spts-stvplus1-nosi.ts b:12000000 tmp/stripped-noav.ts > output/strippedSTVCentral-newAV.ts
